...
Далее нам нужно загрузить ключи на сервер. Делаем это с помощью команлы `ssh-copy-id name@ip` и тогда мы сможем зайти на него без ввода пароля (см. рисунок 16-17)
